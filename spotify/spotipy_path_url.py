...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(
    client_id='12df9db77a67454db1a78d04824a2e18',  # Replace with your Client ID
    client_secret='13ebe77cd8334cbca11bf81bc237c8db'  # Replace with your Client Secret
))
...
file_path = "E:\DAP\metro\spotify\spotify_url.txt"
